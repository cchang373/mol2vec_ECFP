...
def train_word2vec_model(infile_name, outfile_name=None, vector_size=200, window=5, min_count=0, n_jobs=12,
                         method='skip-gram', iter=10000):
